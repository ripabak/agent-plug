...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/agents/new', name: 'agent-create', component: () => import('@/views/AgentCreateView.vue'), meta: { auth: true } },
    { path: '/agents/:id', name: 'agent-detail', component: () => import('@/views/AgentDetailView.vue'), meta: { auth: true } },
